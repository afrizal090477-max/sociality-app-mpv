  ...
  const openLikesModal = async () => {
    ...
    try {
      ...
      const mappedUsers: LikedUser[] = usersData.map((user) => ({
        ...
        isFollowing:
          user.isFollowing ?? myFollowingUsernames.includes(user.username),
      }));
      ...
      <article className="flex flex-col items-start px-[16px] md:px-0 py-0 gap-[8px] md:gap-[12px] w-full max-w-[393px] md:max-w-[600px] mx-auto">
        <div className="flex flex-col items-start p-0 gap-[8px] md:gap-[12px] w-full">
          ...
          <div className="flex flex-row justify-between items-center p-0 w-full h-[28px] md:h-[30px]">
            <div className="flex flex-row items-center gap-[12px] md:gap-[16px]">
              <div className="flex flex-row items-center gap-[6px]">
                <button
                  ...
                  className="flex flex-row items-center group hover:opacity-80 transition-opacity cursor-pointer"
                >
                  <Heart
                    className={`w-[24px] h-[24px] ${isLiked ? "fill-[#B41759] text-[#B41759]" : "text-[#FDFDFD]"}`}
                  />
                </button>
                <button
                  onClick={openLikesModal}
                  className="text-[14px] md:text-[16px] font-semibold text-[#FDFDFD] leading-[28px] md:leading-[30px] tracking-[-0.02em] font-['SF_Pro'] hover:underline cursor-pointer"
                >
                  {likesCount}
                </button>
              </div>
            ...
            >
              <Bookmark
                className={`w-[24px] h-[24px] ${isSaved ? "fill-[#FDFDFD] text-[#FDFDFD]" : "text-[#FDFDFD]"}`}
              />
            </button>
          </div>
          ...
          <div className="flex flex-col items-start p-0 gap-[0px] md:gap-[4px] w-full">
            ...
            {isLongCaption && (
              <button
                ...
                className="text-[14px] md:text-[16px] font-bold md:font-semibold text-[#7F51F9] leading-[28px] md:leading-[30px] tracking-[-0.01em] md:tracking-[-0.02em] hover:text-[#522BC8] transition-colors cursor-pointer font-['SF_Pro']"
              >
