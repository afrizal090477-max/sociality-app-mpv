    ...
    <div className="min-h-screen bg-[#000000] text-white font-['SF_Pro'] relative pb-[100px] md:pb-0">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full max-w-[800px] mx-auto pt-[24px] md:pt-[48px] px-[16px] md:px-0 gap-[32px] md:gap-[48px]">
        <div className="flex flex-col items-center gap-[16px] shrink-0">
          <div
            className={`relative flex items-center justify-center w-[80px] h-[80px] md:w-[130px] md:h-[130px] rounded-full bg-neutral-900 border overflow-hidden ${errors.avatar ? "border-[#B41759]" : "border-[#181D27]"}`}
          >
            {previewAvatar ? (
              <Image
                src={previewAvatar}
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            {errors.avatar && (
              <span className="text-[12px] text-[#B41759] font-medium mt-1">
                {errors.avatar}
              </span>
            )}
          </div>
        ...
        <div className="flex flex-col w-full max-w-[592px] gap-[24px]">
          ...
          <div className="flex flex-col gap-[2px] w-full opacity-60">
            ...
            <span className="text-[14px] text-[#535862] font-medium tracking-[-0.03em] mt-1">
          ...
          <div className="flex flex-col gap-[2px] w-full">
            ...
            <div
              className={`flex w-full bg-[#0A0D12] border rounded-[12px] p-[8px] px-[16px] transition-colors ${errors.bio ? "border-[#B41759]" : "border-[#181D27] focus-within:border-[#7F51F9]"}`}
            >
              <textarea
                value={bio}
